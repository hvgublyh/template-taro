...
// ../../node_modules/.pnpm/@tarojs+plugin-platform-wea_f22e04940bc077f3df0b76f4ef6b790a/node_modules/@tarojs/plugin-platform-weapp/dist/runtime.js
...
function initNativeApi(taro) {
    (0,_chunk_T6OMG3L7_js__WEBPACK_IMPORTED_MODULE_0__.processApis)(taro, wx, {
        needPromiseApis,
        modifyApis (apis) {
...
var hostConfig = {
    ...
    transferHydrateData (data, element, componentsAlias) {
        ...
        if (element.isTransferElement) {
            ...
            page.setData({
                [(0,_chunk_T6OMG3L7_js__WEBPACK_IMPORTED_MODULE_0__.toCamelCase)(data.nn)]: data
            });
            return {
                sid: element.sid,
                ["v"]: "",
...
(0,_chunk_T6OMG3L7_js__WEBPACK_IMPORTED_MODULE_0__.mergeReconciler)(hostConfig);
(0,_chunk_T6OMG3L7_js__WEBPACK_IMPORTED_MODULE_0__.mergeInternalComponents)(components);
